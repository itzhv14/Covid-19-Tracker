...
<div class="container">
  <div class="jumbotron">
  <div class="justify-content-center" style="background-color: red; height: 100px; border-radius:5px; margin-top:auto;"><h1 class="display-4" style="text-align: center; padding-top: 16px;
">HIGH</h1></div>
  <p class="lead"><!-- This is a simple hero unit, a simple jumbotron-style component for calling extra attention to featured content or information. --></p>
  <hr class="my-4">
  <p></p>
  <p class="lead">
    Based on your inputs, we advise the following:
    <b>
Seek immediate medical attention and get yourself tested
Please visit a physician as there may be a requirement for further care
COVID 19 testing may be needed at your physicians advice
    </b>
</p>
...
<script type="text/javascript">
  ...
  xhttp.open("GET", "medium.txt", true);
  xhttp.send();
}
</script>
</body>
