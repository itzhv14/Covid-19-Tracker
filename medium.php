...
<div class="container">
  <div class="jumbotron">
  <div class="justify-content-center" style="background-color: yellow; height: 100px; border-radius:5px; margin-top:auto;"><h1 class="display-4" style="text-align: center; padding-top: 16px;
">MEDIUM</h1></div>
  ...
  <p class="lead">
    ...
    <b>
CONSULT A PHYSICIAN and start home isolation immediately
    </b>
</p>
